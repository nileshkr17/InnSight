...
import DateRangePicker from "../ux/dataRange/DateRangePicker";
...
const GlobalSearchBar = (props) => {
  ...
  return (
    <div className="boxSearch flex flex-wrap flex-col lg:flex-row hero-content__search-box">
      <Input
        size="sm"
      ...
      />
      <button
        className="boxButton w-full md:w-auto sb__button--secondary bg-brand-secondary hover:bg-yellow-600 px-4 py-2 text-white"
